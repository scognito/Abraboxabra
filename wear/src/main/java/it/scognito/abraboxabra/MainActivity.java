...
/*
*  Enable debug AND bluetooth debug in watch
*  In Android wear app, click settings, then enable bluetooth debug
...
public class MainActivity extends Activity {
    ...
    ImageView ivPushButton, ivSettings, ivStatus; //, ivInfo;
    TextView tvLog;
    CheckBox autoPushOnConnect;
    ...
    public void setupViews() {
        ...
        autoPushOnConnect = (CheckBox) findViewById(R.id.checkBox);
    ...
    private void selectBtDevice() {
        ...
        builder.setSingleChoiceItems(btDevicesNameArray, 0, new DialogInterface.OnClickListener() {
            public void onClick(DialogInterface dialog, int item) {
                ...
                setBtServer(btDevicesAddrArray[item].toString());
                setAbraboxabraAddress(btDevicesAddrArray[item].toString());
                dialog.dismiss();
            }
        });
